...
<body>
    <nav>
        <div class="nav-wrapper">
            <div class="container">
                ...
                <a href="#" class="brand-logo center" style="font-family: 'Fredoka One', cursive;">Exercício 3</a>
    ...
    <div class="container">
                ...
                <?php
                    ...
                    if (strlen($_POST["number"]) > 0) {
                        if($number%2==0) {
                            ...
                            echo "<h2>O Número $number é Ímpar</h2>";
                        }
                    }
                ?>
            </div>
        ...
        <ul class="pagination center">
            <li class="waves-effect"><a href="ex2.php"><i class="material-icons">chevron_left</i></a></li>
            ...
            <li class="active"><a href="ex3.php">3</a></li>
            ...
            <li class="waves-effect"><a href="ex4.php"><i class="material-icons">chevron_right</i></a></li>
        </ul>
    </div>
